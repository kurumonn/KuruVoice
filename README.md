...
| 🔉 **DSP チェーン** | DC カット → ノイズゲート → **ピッチ/フォルマント(位相ボコーダ)** → EQ → コンプ → **リミッター** |
| 🎛 **8 プリセット** | Natural Low / Ikemen Soft / Ikemen Deep / Narrator / Clear Streaming / Radio Voice / **Bright High** / **Deep Cool** |
...
| **Bright High** | +6 半音 | 明るく軽い高めの声（高音キャラ方向） | 高い声を作りたい人 |
| **Deep Cool** | -6 半音 | 低く渋い太めの声（低音キャラ方向） | 低い声を作りたい人 |
...
|---|---|---|---|---|
| natural_low | -1.99 半音 | 116 Hz | +11% | 自然に少し低く |
| ikemen_soft | -3.01 半音 | 109 Hz | +20% | 柔らかい低音 |
| ikemen_deep | -4.00 半音 | 103 Hz | -6% | 深く太い |
| narrator | -1.99 半音 | 116 Hz | +14% | 明瞭・通る声 |
| clear_streaming | -1.00 半音 | 123 Hz | +12% | 明るく明瞭 |
| radio_voice | -3.01 半音 | 109 Hz | +10% | 太いラジオ声 |
| **bright_high** | **+5.99 半音** | **184 Hz** | +35% | 明るく高い声 |
| **deep_cool** | **-6.01 半音** | **92 Hz** | +5% | 低く渋い声 |

→ **ピッチは設計値どおり -6〜+6 半音を正確に実現**（130Hz → 92〜184Hz）。位相ボコーダ＋
ケプストラム包絡により大きな変化でも比較的自然で、フォルマント（太さ）も独立に調整できます。
...
```text
DC カット → ノイズゲート → ピッチ/フォルマント(位相ボコーダ) → EQ → コンプレッサー → リミッター
```
